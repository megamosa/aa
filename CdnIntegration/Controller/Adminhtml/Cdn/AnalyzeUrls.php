...
protected function extractUrls($content)
{
    ...
    // تعديل الأنماط لتجنب الأخطاء في التعبيرات العادية
    $patterns = [
        // CSS links
        '/<link[^>]*href=[\'"]((?:[^\'"]+\.css)(?:\?[^\'"]*)?)[\'"][^>]*>/i',
    ...
    $fontPatterns = [
        ...
        // Более сложные паттерны шрифтов
    ...
    // Дополнительные паттерны для merged файлов
    $mergedPatterns = [
    ...
    // Helper-методы для нормализации и проверки
